  ...
  'tpp-checkout': {
    ...
    apisHtml:
      '<div class="sme-dev-section">' +
        ...
        '<div style="margin-top:12px;padding:10px 12px;background:#0B1220;border:1px solid #30363D;border-radius:6px;">' +
          '<div style="font-size:10px;font-weight:700;color:#E6EDF3;text-transform:uppercase;letter-spacing:.6px;margin-bottom:8px;">What each field means</div>' +
          '<div style="display:grid;grid-template-columns:auto 1fr;gap:6px 10px;font-size:10px;line-height:1.5;">' +
            '<code style="color:#A5D6FF;font-family:var(--font-family-mono);">response_type</code><span style="color:#8B949E;">OAuth2 grant to use \u2014 <b style="color:#C9D1D9;">code</b> means the TPP wants an authorisation code it can swap for a token later.</span>' +
            '<code style="color:#A5D6FF;font-family:var(--font-family-mono);">client_id</code><span style="color:#8B949E;">Registered identifier for the TPP (Noon) at Nebras. Proves <i>who</i> is making the request.</span>' +
            '<code style="color:#A5D6FF;font-family:var(--font-family-mono);">scope</code><span style="color:#8B949E;">Permissions being asked for \u2014 <b style="color:#C9D1D9;">payments</b> lets Noon initiate a payment; <b style="color:#C9D1D9;">openid</b> lets it read the customer\'s identity.</span>' +
            '<code style="color:#A5D6FF;font-family:var(--font-family-mono);">request</code><span style="color:#8B949E;">A JWT-signed, JSON-encrypted blob (JAR) holding the full payment intent \u2014 see <i>\u201CInside the signed JAR\u201D</i> below for the decoded contents.</span>' +
            '<code style="color:#A5D6FF;font-family:var(--font-family-mono);">request_uri</code><span style="color:#8B949E;">A short opaque handle Nebras gives back. The device sends only this to ADCB instead of the full payload, so sensitive fields never sit in the URL bar.</span>' +
            '<code style="color:#A5D6FF;font-family:var(--font-family-mono);">expires_in</code><span style="color:#8B949E;">Seconds before the <code style="color:#A5D6FF;">request_uri</code> is discarded. <b style="color:#C9D1D9;">60s</b> is tight on purpose \u2014 if the customer stalls, they must retry.</span>' +
          '</div>' +
        '</div>' +
        /* Decoded JWT payload */
        '<div style="margin-top:12px;padding:10px 12px;background:#0B1220;border:1px solid #30363D;border-radius:6px;">' +
          '<div style="font-size:10px;font-weight:700;color:#E6EDF3;text-transform:uppercase;letter-spacing:.6px;margin-bottom:6px;">Inside the signed JAR (decoded JWT body)</div>' +
          '<div style="font-size:10px;color:#8B949E;line-height:1.5;margin-bottom:8px;">The <code style="color:#A5D6FF;">request</code> field is a JWT whose body carries the <b style="color:#C9D1D9;">actual payment intent</b>. Nebras and ADCB verify the signature, then act on these claims:</div>' +
          '<pre class="sme-code-block" style="margin:0;"><span class="sme-cv">{\n  </span><span class="sme-cs">"iss"</span><span class="sme-cv">: </span><span class="sme-cs">"tpp-noon-001"</span><span class="sme-cv">,           </span><span class="sme-ck">// who signed it (the TPP)</span><span class="sme-cv">\n  </span><span class="sme-cs">"aud"</span><span class="sme-cv">: </span><span class="sme-cs">"https://nebras.ae/as"</span><span class="sme-cv">,   </span><span class="sme-ck">// who it\'s for (the hub)</span><span class="sme-cv">\n  </span><span class="sme-cs">"iat"</span><span class="sme-cv">: </span><span class="sme-cn">1704067200</span><span class="sme-cv">,                  </span><span class="sme-ck">// issued-at epoch</span><span class="sme-cv">\n  </span><span class="sme-cs">"exp"</span><span class="sme-cv">: </span><span class="sme-cn">1704067260</span><span class="sme-cv">,                  </span><span class="sme-ck">// expires 60s later</span><span class="sme-cv">\n  </span><span class="sme-cs">"state"</span><span class="sme-cv">: </span><span class="sme-cs">"af0ifjsldkj"</span><span class="sme-cv">,             </span><span class="sme-ck">// CSRF token, echoed back</span><span class="sme-cv">\n  </span><span class="sme-cs">"nonce"</span><span class="sme-cv">: </span><span class="sme-cs">"n-0S6_WzA2Mj"</span><span class="sme-cv">,            </span><span class="sme-ck">// replay protection</span><span class="sme-cv">\n  </span><span class="sme-cs">"redirect_uri"</span><span class="sme-cv">: </span><span class="sme-cs">"https://noon.com/cb"</span><span class="sme-cv">,\n  </span><span class="sme-cs">"authorization_details"</span><span class="sme-cv">: [{\n    </span><span class="sme-cs">"type"</span><span class="sme-cv">: </span><span class="sme-cs">"payment_initiation"</span><span class="sme-cv">,\n    </span><span class="sme-cs">"instructedAmount"</span><span class="sme-cv">: {\n      </span><span class="sme-cs">"amount"</span><span class="sme-cv">: </span><span class="sme-cs">"100.00"</span><span class="sme-cv">,\n      </span><span class="sme-cs">"currency"</span><span class="sme-cv">: </span><span class="sme-cs">"AED"</span><span class="sme-cv">\n    },\n    </span><span class="sme-cs">"creditorAccount"</span><span class="sme-cv">: {\n      </span><span class="sme-cs">"schemeName"</span><span class="sme-cv">: </span><span class="sme-cs">"IBAN"</span><span class="sme-cv">,\n      </span><span class="sme-cs">"identification"</span><span class="sme-cv">: </span><span class="sme-cs">"AE210610012345678901234"</span><span class="sme-cv">,\n      </span><span class="sme-cs">"name"</span><span class="sme-cv">: </span><span class="sme-cs">"Noon Ltd"</span><span class="sme-cv">\n    },\n    </span><span class="sme-cs">"remittanceInformation"</span><span class="sme-cv">: {\n      </span><span class="sme-cs">"reference"</span><span class="sme-cv">: </span><span class="sme-cs">"ORD-20260416-001"</span><span class="sme-cv">\n    }\n  }]\n}</span></pre>' +
          '<div style="font-size:10px;color:#8B949E;line-height:1.5;margin-top:8px;">The signature (RS256 / PS256) is made with the TPP\'s private key. ADCB fetches Noon\'s public key from the OF Hub registry and verifies it before executing anything.</div>' +
        '</div>' +
      '</div>'
  },
